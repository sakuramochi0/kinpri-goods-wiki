...
IGNORE_URLS = [
    ...
    'd/%a5%ad%a5%e3%a5%f3%a5%da%a1%bc%a5%f3%a1%a6%b4%fc%b4%d6%b8%c2%c4%ea%a5%b7%a5%e7%a5%c3%a5%d7%a1%a6%a5%a4%a5%d9'
    '%a5%f3%a5%c8%c8%ce%c7%e4%be%f0%ca%f3',
    # 同・終了分
    'd/%a5%ad%a5%e3%a5%f3%a5%da%a1%bc%a5%f3%a1%a6%b4%fc%b4%d6%b8%c2%c4%ea%a5%b7%a5%e7%a5%c3%a5%d7%a1%a6%a5%a4%a5%d9'
    '%a5%f3%a5%c8%c8%ce%c7%e4%be%f0%ca%f3%a1%ca%bd%aa%ce%bb%ca%ac%a1%cb',
]
# prepend a base url
...
def save_item(item):
    # use page url as id
    item_id = '/'.join(item['url'].split('/')[4:])
    db.update({'_id': item_id}, {'$set': item}, upsert=True)
...
def parse_page(url):
    ...
    # get release_date
    m = re.search(r'((?:(?:(\d{4})年)?(\d{,2})月(?:(\d{,2})日)?.*?(?:([上中下])旬)?.*?)|発売.+?不明)', soup.text)
    if m:
